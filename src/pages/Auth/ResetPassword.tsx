...
export default function ResetPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(error.response?.data?.message || 'Failed to reset password. Verify email or code.');
    } finally {
      setLoading(false);
    }
  };
    ...
    >
      ...
      >
        ...
        <Typography variant="body2" sx={{ color: 'text.secondary', mb: 3 }}>
          Enter the verification code sent to your email to save your new password.
        </Typography>
